...
public static class Blog
{
    ...
    //method to return the avaiable posts from a xml file
    public static Dictionary<string, string> getProjects()
    {
        XmlDocument projectsdoc = new XmlDocument();
        projectsdoc.Load(HttpContext.Current.Server.MapPath("/projects/projects.xml"));
        var result = new Dictionary<string, string>();


        XmlElement root = projectsdoc.DocumentElement;
        XmlNodeList xmlNodes = root.SelectNodes("/projects/project");
         XmlNodeList xmlNodes2 = projectsdoc.GetElementsByTagName("project");
